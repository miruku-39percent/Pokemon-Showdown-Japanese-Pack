...
var translations = {
	...
	"Armor Tail":"テイルアーマー",
	"Aroma Veil": "アロマベール",
	"As One (Glastrier)": "じんばいったい (ブリザポス)",
	"As One (Spectrier)": "じんばいったい (レイスポス)",
	"As One": "じんばいったい",
	"Aura Break": "オーラブレイク",
	"Bad Dreams": "ナイトメア",
	"Ball Fetch": "たまひろい",
	...
	"Embody Aspect (Teal)": "おもかげやどし(みどり)",
	"Embody Aspect (Cornerstone)": "おもかげやどし(いしずえ)",
	"Embody Aspect (Hearthflame)": "おもかげやどし(かまど)",
	"Embody Aspect (Wellspring)": "おもかげやどし(いど)",
    ...
    "Raticate-Alola-Totem": "ラッタ-アローラ-ぬし",
    ...
    "Pikachu-Original": "ピカチュウ-オリジナル",
    "Pikachu-Hoenn": "ピカチュウ-ホウエン",
    "Pikachu-Sinnoh": "ピカチュウ-シンオウ",
    "Pikachu-Unova": "ピカチュウ-イッシュ",
    "Pikachu-World": "ピカチュウ-ワールド",
    "Pikachu-Kalos": "ピカチュウ-カロス",
    "Pikachu-Alola": "ピカチュウ-アローラ",
    "Pikachu-Partner": "ピカチュウ-キミにきめた",
    "Pikachu-Starter": "相棒ピカチュウ",
    "Pikachu-Gmax": "ピカチュウ-キョダイマックス",
    "Meowth-Galar": "ニャース-ガラル",
    "Meowth-Gmax": "ニャース-キョダイマックス",
    "Machamp-Gmax": "カイリキー-キョダイマックス",
    "Farfetch’d-Galar": "カモネギ-ガラル",
    "Gengar-Gmax": "ゲンガー-キョダイマックス",
    "Kingler-Gmax": "キングラー-キョダイマックス",
    "Marowak-Alola-Totem": "ガラガラ-アローラ-ぬし",
    "Weezing-Galar": "マタドガス-ガラル",
    "Mr. Mime-Galar": "バリヤード-ガラル",
    "Lapras-Gmax": "ラプラス-キョダイマックス",
    "Eevee-Starter": "相棒イーブイ",
    "Eevee-Gmax": "イーブイ-キョダイマックス",
    "Snorlax-Gmax": "カビゴン-キョダイマックス",
    "Urshifu-Gmax": "ウーラオス-キョダイマックス",
    "Pichu-Spiky-eared": "ギザみみピチュー",
    ...
    "Vivillon-Pokeball": "ビビヨン-ボール",
    "Meowstic-F": "ニャオニクス-メス",
    "Oinkologne-F": "パフュートン-メス",
    "Basculegion-F": "イダイトウ-メス",
    ...
    "Toxtricity-Gmax": "ストリンダー-キョダイマックス",
    ...
    "-Rapid-Strike-Gmax": "-れんげき-キョダイマックス",
    "-Low-Key-Gmax": "-ロー-キョダイマックス",
    "-Droopy": "-たれた",
    "-Stretchy": "-のびた",
    "-Blue": "-ブルー",
    "-Yellow": "-イエロー",
    ...
    "Squawkabilly-Blue": "イキリンコ-ブルー",
    "Squawkabilly-White": "イキリンコ-ホワイト",
    "Squawkabilly-Yellow": "イキリンコ-イエロー",
    "Gimmighoul-Roaming": "コレクレー-とほ",
    "Ursaluna-Bloodmoon": "ガチグマ-アカツキ",
    "Ogerpon-Cornerstone": "オーガポン-いしずえ",
    "Ogerpon-Wellspring": "オーガポン-いど",
    "Ogerpon-Hearthflame": "オーガポン-かまど",
    "Terapagos-Stellar": "テラパゴス-ステラ",
    "Terapagos-Terastal": "テラパゴス-テラスタル",
    "Poltchageist-Artisan": "チャデス-タカイモノ",
    "Sinistcha-Masterpiece": "ヤバソチャ-ケッサク",
    "Polteageist-Antique": "ポットデス-しんさく",
    "Sinistea-Antique": "ヤバチャ-しんさく",
    "Tauros-Paldea-Blaze": "ケンタロス-パルデア-ブレイズ",
    "Tauros-Paldea-Aqua": "ケンタロス-パルデア-ウォーター",
    "Tauros-Paldea-Combat": "ケンタロス-パルデア-コンバット",
    ...
    "Zacian-*": "ザシアン-不明",
    "Zamazenta-*": "ザマゼンタ-不明",
    "Dudunsparce-*": "ノココッチ-不明",
    "Gourgeist-*": "パンプジン-不明",
    "Pumpkaboo-*": "·バケッチャ-不明",
    "Urshifu-Rapid-Strike-Gmax": "ウーラオス-れんげき-キョダイマックス",
    "Ogerpon-Wellspring-Tera": "オーガポン-いど-テラスタル",
    "Ogerpon-Cornerstone-Tera": "オーガポン-いしずえ-テラスタル",
    "Ogerpon-Hearthflame-Tera": "オーガポン-かまど-テラスタル",
    "Ogerpon-Teal-Tera": "オーガポン-みどり-テラスタル",
    "Ogerpon-Tera": "オーガポン-テラスタル",
    "-Wellspring-Tera": "-いど-テラスタル",
    "-Cornerstone-Tera": "-いしずえ-テラスタル",
    "-Hearthflame-Tera": "-かまど-テラスタル",
    "-Teal-Tera": "-みどり-テラスタル",  
    ...
    "Ogerpon-Cornerstone: 1.2x power attacks; Terastallize to gain Embody Aspect.": "オーガポン-础石携带后招式威力提升20%；太晶化后特性变为面影辉映",
    "Ogerpon-Hearthflame: 1.2x power attacks; Terastallize to gain Embody Aspect.": "オーガポン-火灶携带后招式威力提升20%；太晶化后特性变为面影辉映",
    "Ogerpon-Wellspring: 1.2x power attacks; Terastallize to gain Embody Aspect.": "オーガポン-水井携带后招式威力提升20%；太晶化后特性变为面影辉映",
    ...
    "Has a higher chance for a critical hit. If the user is an Ogerpon holding a mask, this move's type changes to match. Water type for Wellspring Mask, Fire type for Hearthflame Mask, and Rock type for Cornerstone Mask.": "容易击中要害。该招式的属性会根据使用者的面具而改变：オーガポン-水井面具使用时，会变为水属性。オーガポン-火灶面具使用时，会变为火属性。オーガポン-础石面具使用时，会变为岩石属性。",
